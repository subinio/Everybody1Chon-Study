...
<body>
  <div class="container">
    ...
    <section>
      <div class="management_certificationboard_style">
          <div class="container">
            ...
            <div class="group_nav">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="./management_certificationboard.php?s_no=<? echo $s_no ?>">인증게시판</a>
                </li>
                <li class="nav-item">
              ...
              <table class="table">
                ...
                <tbody>
                  <?
                    ...
                    $query = "select * from study_cboard where study_num = '$s_no' order by date desc, no desc;";
